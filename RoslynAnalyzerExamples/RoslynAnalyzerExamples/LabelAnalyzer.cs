...
namespace RoslynAnalyzerExamples
{
    ...
    class LabelAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "LabelXSS01";
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(AnalyzeLabelTextProperty, SyntaxKind.SimpleAssignmentExpression);
        }
        ...
        private static void AnalyzeLabelTextProperty(SyntaxNodeAnalysisContext context)
        {
            ...
            {
                if(context.SemanticModel.GetSymbolInfo(((AssignmentExpressionSyntax)context.Node).Left).Symbol.ToString() == "System.Web.UI.WebControls.Label.Text")
                {
